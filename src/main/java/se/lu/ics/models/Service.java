...
public class Service {
    public enum ServiceType {
        ...
        WHEEL_BALANCE(500),
        ALIGNMENT(500),
        BRAKE_ADJUSTMENT(500),
        BRAKE_REPLACEMENT(1000),
        TRANSMISSION_FLUSH(1000),
        ENGINE_FLUSH(1000),
        ENGINE_REPAIR(1000),
        ENGINE_REPLACEMENT(1000),
        BI_ANNUAL_MAINTENANCE(10000),
        ANNUAL_MAINTENANCE(30000),
        BI_ANNUAL_MAINTENANCE_WITH_OIL_CHANGE(15000),
        ANNUAL_MAINTENANCE_WITH_OIL_CHANGE(45000);
